...
function LanguageSwitch() {
    ...
    return (
        <div className="relative mr-5">
            ...
            />
            {isOpen && (
                <div className="absolute flex flex-col items-center z-50 mt-2 py-2 gap-2 w-30 px-2 bg-secondary rounded shadow-lg transition duration-300 ease-in-out transform origin-top">
